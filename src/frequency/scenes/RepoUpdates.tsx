...
export const RepoUpdates: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16, width: 580 }}>
        {/* Header */}
        <div style={{ opacity: headerSpring, transform: `translateY(${interpolate(headerSpring, [0, 1], [15, 0])}px)` }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
            <svg width="22" height="22" viewBox="0 0 16 16" fill={colors.accent}>
            ...
            <h2 style={{ fontFamily: fonts.body, fontSize: 24, fontWeight: 800, color: colors.text, letterSpacing: "-0.03em", margin: 0 }}>app-factory</h2>
          </div>
          ...
          {FILE_TREE.map((file, i) => {
            ...
            return (
              ...
              >
                ...
                {isNew && (
                  <span style={{ fontFamily: fonts.mono, fontSize: 8, color: colors.positive, textTransform: "uppercase" as const, letterSpacing: "0.1em", opacity: 0.8 }}>new</span>
                )}
                {isModified && (
                  <span style={{ fontFamily: fonts.mono, fontSize: 8, color: colors.warning, textTransform: "uppercase" as const, letterSpacing: "0.1em", opacity: 0.8 }}>mod</span>
                )}
              </div>
            );
          })}
